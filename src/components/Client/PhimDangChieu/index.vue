<template >
  ...
  <div class="container">
      <div class="row">
      <h2 class="text-center mt-3">Phim Đang Chiếu</h2>
        <template v-for="(value,index) in PhimDangChieu" :key="index">
      <div class="col-lg-3 ">
...
export default {
  ...
  methods: {
      ...
      getPhimDangChieu() {
          axios
              .get("https://be24.deloydz.com/api/34034000-068000-102000-136000/client/phim-dang-chieu/get-data")
              .then((res) => {
                  this.PhimDangChieu=res.data.data;
              });
      },
