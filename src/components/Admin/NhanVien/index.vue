...
export default {
    ...
    methods: {
        loadDataNhanVien() {
            axios
                .get('https://be24.deloydz.com/api/39039000-078000-117000-156000/admin/nhan-vien/get-data')
                .then((res) => {
        ...
        loadDataChucVu() {
            axios
                .get('https://be24.deloydz.com/api/39039000-078000-117000-156000/admin/chuc-vu/get-data')
                .then((res) => {
        ...
        addNhanVien() {
            axios
                .post('https://be24.deloydz.com/api/39039000-078000-117000-156000/admin/nhan-vien/add-data', this.create_nhan_vien)
                .then((res) => {
                    if (res.data.status) {
        ...
        updateNhanVien() {
            axios
                .post('https://be24.deloydz.com/api/39039000-078000-117000-156000/admin/nhan-vien/update', this.update_nhan_vien)
                .then((res) => {
                    if (res.data.status) {
                        this.loadDataNhanVien();
                             alert(res.data.message);
        ...
        deleteNhanVien() {
            axios
                .post('https://be24.deloydz.com/api/39039000-078000-117000-156000/admin/nhan-vien/delete', this.delete_nhan_vien)
                .then((res) => {
                    if (res.data.status) {
                        this.loadDataNhanVien();
                             alert(res.data.message);
